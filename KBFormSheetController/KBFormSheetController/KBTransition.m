...
- (void)entryFormSheetControllerTransition:(KBFormSheetController *)formSheetController completionHandler:(void (^)(void))completionHandler
{
    NSAssert(NO, @"must be implemented!");
}

- (void)exitFormSheetControllerTransition:(KBFormSheetController *)formSheetController completionHandler:(void (^)(void))completionHandler
{
    NSAssert(NO, @"must be implemented!");
}
